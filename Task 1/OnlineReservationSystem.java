...
public class OnlineReservationSystem {
	...
	public static void main(String[] args) {
	    ...
	    public static void SIGNIN() {
	        ...
	        System.out.println("-------------|| SIGN IN SUCCESSFULY !!! ||--------------");
	        System.out.println("--------------------------------------------------------");
            LOGIN(id,pw);
	    ...
	    public static void LOGIN(String id, String pw) {
	        ...
	        if(id.equals(L_id)) {
	        	if(pw.equals(L_pw)) {
	        		System.out.println("--------|| LOGIN IN SUCCESSFULY !!! ||---------");
	        		System.out.println("--------------------------------------------------");
	        		System.out.println("----------------|| PRESS BUTTON ||--------------");
	    ...
	    public static void ticket(String name, int age, String start, String end, int PRN, int Class_Type, String date, String train_name, int Train_Number) {
	        ...
	        System.out.println(train_name + "\t\t\t\t\t" + Train_Number + "\t\t\t\t" + PRN + "\t\t\t\t" + Class_Type);
	    ...
	    public void Cancelticket(String name, int age, String start, String end, int PRN, int Class_Type, String date, String train_name, int Train_Number) {
